...
[assembly: InternalsVisibleTo("DAO")]
namespace SharpCore.Data
{
	...
	/// <see cref="ISessionFactory" /></description></item>
    ...
    public interface ICurrentSessionContext
	{
        ...
        /// <exception cref="Exception">Typically indicates an issue
		/// locating or creating the current session.</exception>
		ISessionTX CurrentSession();

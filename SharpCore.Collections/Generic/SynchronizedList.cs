...
namespace SharpCore.Collections.Generic
{
	/// <summary>
	...
	public class SynchronizedList<T> : IList<T>, ICollection<T>, IEnumerable<T>, IList, ICollection, IEnumerable
	{
		...
		/// <returns>zero-based index of the first occurrence of item within the range of elements in the List that extends from index to the last element, if found; otherwise, –1.</returns>
